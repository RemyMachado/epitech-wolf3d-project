...
void Player::move(float direction_deg) {
  ...
  std::optional<Raycast>
      raycast_wall_x =
      raycast(this->pos, x_dir_deg, camera.render_distance, this->grid, UNWALKABLE_TILES);
  ...
  std::optional<Raycast>
      raycast_wall_y = raycast(this->pos, y_dir_deg, camera.render_distance, this->grid, UNWALKABLE_TILES);
