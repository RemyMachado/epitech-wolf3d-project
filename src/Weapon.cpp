 ...
 * */
bool Weapon::is_enemy_in_attack_range(sf::Vector2f player_pos, const Enemy &Enemy) {
  // TODO:
  return true;
}
bool Weapon::try_attack(sf::Vector2f player_pos, std::vector<Enemy> &enemies) {
  ...
  for (auto &enemy : enemies) {
	...
	if (is_enemy_in_attack_range(player_pos, enemy)) {
